...
def render_colours(colours: list, output_file: str="theme.png"):
    ...
    for i,colour in enumerate(colours):
        ...
        ax.text(col + 0.5, -row - 0.5, colour, ha='center', va='center', fontsize=18, color='white', bbox=dict(facecolor='black', edgecolor='none', boxstyle='square,pad=0.'))
    ax.set_xlim(0, 4)
    ax.set_ylim(-4, 0)
    ax.set_xticks([])
    ax.set_yticks([])
